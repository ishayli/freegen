...
const App: React.FC = () => {
  ...
  const applyWatermarks = useCallback(async (imageUrl: string | null) => {
    ...
    try {
      const invisiblyWatermarked = await embedWatermark(imageUrl, "FREEgenerate");
      const visiblyWatermarked = await addVisibleWatermark(invisiblyWatermarked, "FREEgenerate");
